          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <div className="text-2xl font-bold">
                ...
                <span className="text-orange-400">GHOR</span>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex w-full md:w-auto">
              <input
                ...
                className="px-4 py-2 bg-gray-800 text-white border border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-teal-400 flex-1 md:w-80"
              />
              <button className="px-6 py-2 bg-teal-500 hover:bg-teal-600 text-white rounded-r-lg transition-colors">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 TechGhor. All rights reserved. Designed with ❤️ for
              innovation.
            </p>
